...
async function LoadsReadOSC() {
    ...
    oscServer.on('listening', function () {
        console.log(`VRChat is listening on port '${config.VRCACC.OSC_READ_PORT}' To Read OSC`);
    });
}
    ...
    switch (address) {
        ...
        case '/avatar/parameters/Chest_Hit':
            ...
            if (args[0] == true) {
                ...
                var msgchest = "Please do not touch me there, thats my privacy part of my body that no one not allowed touch other then my master.";
