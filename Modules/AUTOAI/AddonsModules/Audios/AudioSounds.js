...
function playThugLife(audioFile) {
    ...
    sendOSC(
        "/avatar/parameters/asset/interactive/",
        value,
        valueoff
    );
    DownloadFile('memes', 'https://www.myinstants.com/media/sounds/dr-dre-nuthin-but-a-g-thang.mp3', 'memes', 'thug_life');
...
function playDespacito(audioFile) {
    ...
    DownloadFile('memes', 'https://www.myinstants.com/media/sounds/despacito.mp3', 'memes', 'despacito');
...
function playExecuteOrder66(audioFile) {
    ...
    DownloadFile('memes', 'https://www.myinstants.com/media/sounds/order66.mp3', 'memes', 'order66');
...
function playTripToValhalla(audioFile) {
    ...
    DownloadFile('memes', 'https://www.myinstants.com/media/sounds/trip-to-valhalla.mp3', 'memes', 'TripToValhalla');
    ...
    const randomUrlArray = [
        {
            ...
            url: 'https://www.myinstants.com/media/sounds/emotional-damage-remix-better-audio.mp3'
        },
        {
            name: 'thats_alot_of_emotional_damage',
            url: 'https://www.myinstants.com/media/sounds/thats-alot-of-emotional-damage.mp3'
        },
        {
        ...
        },
        {
            ...
            url: 'https://www.myinstants.com/media/sounds/emotional-damage_svaNMfN.mp3'
        }
    ];

    const randomSoundData = generateRandomArray(randomUrlArray);
    DownloadFile('memes', randomSoundData.url, 'memes', randomSoundData.name.toLowerCase().replace(/\s/g, '_'));
    startRecordingAndRunDeepSpeech();
}
